...
public final class ServerFlag {
    ...
    public static final int PARALLEL_CHUNK_LOAD_SIZE = intProperty("minestom.parallel-chunk-load-size", 4);
    public static final int PARALLEL_CHUNK_SAVE_SIZE = intProperty("minestom.parallel-chunk-save-size", 8);
    public static final int BATCH_POOL_SIZE = intProperty("minestom.batch-pool-size", 4);
