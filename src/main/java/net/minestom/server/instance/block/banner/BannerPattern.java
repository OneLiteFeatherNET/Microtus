...
public sealed interface BannerPattern extends ProtocolObject, BannerPatterns permits BannerPatternImpl {
    @NotNull NetworkBuffer.Type<Key> NETWORK_TYPE = NetworkBuffer.RegistryKey(Registries::bannerPattern);
    @NotNull BinaryTagSerializer<Key> NBT_TYPE = BinaryTagSerializer.registryKey(Registries::bannerPattern);
