...
public class PaintingMeta extends EntityMeta implements ObjectDataProvider {
    ...
    public @NotNull Key getVariant() {
        return super.metadata.getIndex(OFFSET, Variant.KEBAB);
    }

    public void setVariant(@NotNull Key value) {
    ...
    public sealed interface Variant extends ProtocolObject, PaintingVariants permits VariantImpl {
        @NotNull NetworkBuffer.Type<Key> NETWORK_TYPE = NetworkBuffer.RegistryKey(Registries::paintingVariant);
        @NotNull BinaryTagSerializer<Key> NBT_TYPE = BinaryTagSerializer.registryKey(Registries::paintingVariant);
