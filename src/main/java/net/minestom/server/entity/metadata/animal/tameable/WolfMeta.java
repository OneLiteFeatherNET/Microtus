...
public class WolfMeta extends TameableAnimalMeta {
    ...
    public sealed interface Variant extends ProtocolObject, WolfVariants permits VariantImpl {
        @NotNull NetworkBuffer.Type<Key> NETWORK_TYPE = NetworkBuffer.RegistryKey(Registries::wolfVariant);
        @NotNull BinaryTagSerializer<Key> NBT_TYPE = BinaryTagSerializer.registryKey(Registries::wolfVariant);
