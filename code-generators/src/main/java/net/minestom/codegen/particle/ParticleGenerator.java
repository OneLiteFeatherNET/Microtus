...
public class ParticleGenerator extends MinestomCodeGenerator {
    ...
    public ParticleGenerator(@Nullable InputStream particlesFile, @NotNull File outputFolder) {
        super("net.minestom.server.particle");
    ...
    public void generate() {
        ...
        ClassName particleCN = ClassName.get(packageName, "Particle");
        ClassName particleImplCN = ClassName.get(packageName, "ParticleImpl");
        ...
        // Start code gen
        ClassName particlesCN = ClassName.get(packageName, "Particles");
        ...
        for (Map.Entry<String, JsonElement> particleIdObjectEntry : orderedParticleIdObjectEntries) {
            ...
            if (value.get("hasData").getAsBoolean()) {
                ...
                fieldCN = ClassName.get(packageName, "Particle",
        ...
        writeFiles(
                List.of(JavaFile.builder(packageName, particlesInterface.build())
                        .indent("    ")
